...
public class GameObj
{
    ...
    boolean visible  = true;     // Can be seen on the screen (change to false when the brick gets hit)
    int topX   = 0;              // Position - top left corner X
    int topY   = 0;              // position - top left corner Y
    int width  = 0;              // Width of object
    int height = 0;              // Height of object
    Color colour;                // Colour of object
    int dirX   = 1;            // Direction X (1, 0 or -1)
    int dirY   = 1;            // Direction Y (1, 0 or -1)
