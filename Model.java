...
public class Model 
{
    ...
    int B              = 6;      // Border round the edge of the panel
    int M              = 40;     // Height of menu bar space at the top

    int BALL_SIZE      = 30;     // Ball side
    int BRICK_WIDTH    = 50;     // Brick size
    int BRICK_HEIGHT   = 30;

    int BAT_MOVE       = 5;      // Distance to move bat on each keypress
    int BALL_MOVE      = 3;      // Units to move the ball on each step

    int HIT_BRICK      = 50;     // Score for hitting a brick
    int HIT_BOTTOM     = -200;   // Score (penalty) for hitting the bottom of the screen
    ...
    {       
        ...
        // *[1]******************************************************[1]*
        // * Fill in code to make the more bricks                     *
        // **************************************************************
    ...
    public synchronized void updateGame()
    {
       ...
       // check whether ball has hit a (visible) brick
        ...
        // * check if a visible brick has been hit      *
